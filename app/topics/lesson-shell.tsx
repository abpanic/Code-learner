...
export function LessonShell({
  ...
  return <main className="lesson-shell"><NavigationReset />
    <header className="lesson-topbar"><div className="lesson-topbar-inner"><Link href="/" className="lesson-brand"><span className="brand-mark">AI<span className="brand-dot">·</span>ML</span><span>Competency Matrix</span></Link><Link href="/" className="lesson-back"><ArrowLeft size={16} /> All topics</Link></div></header>
    <div className="lesson-container">
      <nav aria-label="Breadcrumb" className="lesson-breadcrumb"><Link href="/">Skills explorer</Link><span>/</span><span>Core ML</span><span>/</span><strong>{title}</strong></nav>
      ...
      <div className="lesson-layout">
        ...
        <div className="lesson-main">
          ...
          <Link href="/" className="lesson-end-link"><ArrowLeft size={16} /> Back to all topics <ArrowUpRight size={16} /></Link>
        </div>
      </div>
    </div>
  </main>;
